...
describe('The tlint provider for Linter', () => {
  ...
  describe('checks use.php and', () => {
    ...
    it('verifies the results', async () => {
      ...
      expect(messages[0].location.position).toEqual([[2, 0], [2, 6]]);
      ...
      expect(messages[1].location.position).toEqual([[2, 0], [2, 6]]);
      ...
      expect(messages[2].location.position).toEqual([[3, 0], [3, 6]]);
